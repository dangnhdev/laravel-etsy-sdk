 ...
 * **NOTE** Access to ShopReceipt's first_line, second_line, city, state, zip, country_iso and
 * formatted_address is contingent in some regions to a preferred partnership status with Etsy
 */
class UpdateShopReceipt extends Request
{

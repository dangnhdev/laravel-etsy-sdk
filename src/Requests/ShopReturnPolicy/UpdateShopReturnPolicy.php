 ...
 * use.</p></div>
 *
 * Updates an existing Return Policy. Note: if either accepts_returns or
 * accepts_exchanges is true, then a return_deadline is required.
 */
class UpdateShopReturnPolicy extends Request
{

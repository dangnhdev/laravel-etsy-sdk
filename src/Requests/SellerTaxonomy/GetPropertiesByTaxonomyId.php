 ...
 * for a specific seller taxonomy ID.
 */
class GetPropertiesByTaxonomyId extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v3/application/seller-taxonomy/nodes/{$this->taxonomyId}/properties";
    }

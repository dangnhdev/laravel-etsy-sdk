 ...
 * use.</p></div>
 *
 * NOTE: This endpoint is being deprecated in favor of not requiring the shops/:shop_id
 * as part of the URL. Retrieves the references and metadata for a listing image with a specific image
 * ID.
 */
class GetListingImageDeprecated extends Request
{

 ...
 * use.</p></div>
 *
 * Open API V3 endpoint to delete a listing video. A copy of the video remains on our
 * servers, and so a deleted video may be re-associated with the listing without re-uploading the
 * original video; see uploadListingVideo.
 */

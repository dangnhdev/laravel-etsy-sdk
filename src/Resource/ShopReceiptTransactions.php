...
class ShopReceiptTransactions extends Resource
{
     ...
     */
    public function getShopReceiptTransactionsByListing(int $shopId, int $listingId, ?int $limit = null, ?int $offset = null): Response
    {
     ...
     * @param  int  $offset  The number of records to skip before selecting the first result.
     */
    public function getShopReceiptTransactionsByShop(int $shopId, ?int $limit = null, ?int $offset = null): Response
    {

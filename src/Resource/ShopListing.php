...
class ShopListing extends Resource
{
     ...
     */
    public function getListing(int $listingId, ?array $includes = null, ?string $language = null): Response
    {
     ...
     * @param  array  $includes  An enumerated string that attaches a valid association. Acceptable inputs are 'Shipping', 'Shop', 'Images', 'User', 'Translations' and 'Inventory'.
     */
    public function getListingsByListingIds(array $listingIds, ?array $includes = null): Response
    {
     ...
     * @param  int  $offset  The number of records to skip before selecting the first result.
     */
    public function getFeaturedListingsByShop(int $shopId, ?int $limit = null, ?int $offset = null): Response
    {
     ...
     * @param  int  $offset  The number of records to skip before selecting the first result.
     */
    public function getListingsByShopReceipt(int $receiptId, int $shopId, ?int $limit = null, ?int $offset = null): Response
    {
